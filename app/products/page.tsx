              ...
              return (
                ...
                >
                  {contactSlugs.has(product.slug) ? (
                    ...
                    >
                      <div className="h-full glass rounded-2xl border border-border hover:border-primary/30 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer overflow-hidden flex flex-col">
                        <div className="relative h-40 bg-gradient-to-br from-primary/20 to-secondary/20 overflow-hidden">
                          <Image
                            src={productImage || "/placeholder.svg"}
                            alt={product.name}
